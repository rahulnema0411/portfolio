  ...
  return (
    <nav className="p-8 flex justify-between items-center">
      <div className="flex flex-row justify-between items-center w-full sm:w-auto">
        <div className="text-black text-2xl font-calistoga">
          Rahul Nema
        </div>
        ...
        >
          <li>
            <a href="#" className="text-black font-montserrat font-bold text-sm">
              Home
            </a>
          </li>
          <li>
      ...
      <div className="hidden sm:flex flex-row justify-between md:justify-normal items-center">
        ...
        <a href="#" className="">
          ...
          <li>
        <a href="#" className="text-black font-montserrat font-bold">
